...
def random_forest_with_kfold(file_path: str, target_column: str, k: int):
    # Load the dataset
    ...
    for train_index, test_index in skf.split(X, y):
        ...
        model = RandomForestClassifier(criterion='gini', random_state=42, n_estimators=100)
...
# Call the function
random_forest_with_kfold(file_path, target_column, k)
